...
<%
	...
	String empID="",sel="";
		...
		String q4="select count(attdate) AS cnt, MONTH(attdate) AS mon from attendance where uid='"+empID+"' AND YEAR(attdate)='"+yr+"' AND attdate < '"+monthBegin+"' GROUP BY MONTH(attdate)";
